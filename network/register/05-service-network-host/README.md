...
|[Service Required](https://github.com/edgedock/example/tree/master/network/register/05-service-required) | **Service Network Host** | [Register](https://github.com/edgedock/example/tree/master/network/registert)  |
|:--|:-:|--:|
